...
def change_general(preload_path, build_plan_path, count):
	...
	for i in range(5, bp.nrows):
		vm = bp.cell_value(i, 1)
		modules_model = bp.cell_value(i, 8)
