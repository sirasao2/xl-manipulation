...
def names_tag_sheet(preload_path, build_plan_path):
	...
	lba_list = []
	for i in range(5, bp.nrows):
		if "prb" in bp.cell_value(i, 7):
			prb_list.append((bp.cell_value(i, 7)))
		if "qrt" in bp.cell_value(i, 7):
			qrt_list.append(bp.cell_value(i, 7))
		if "lba" in bp.cell_value(i, 7):
			lba_list.append(bp.cell_value(i, 7))
